...
\* Add fairness conditions to ensure processes make progress
Fairness == \A self \in 1..2 :
            /\ WF_vars(CheckAndWithdraw(self))
            /\ WF_vars(Deposit(self))

\* Modified specification with fairness
